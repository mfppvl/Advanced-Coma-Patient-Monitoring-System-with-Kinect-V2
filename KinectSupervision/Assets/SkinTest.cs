...
public class SkinTest : MonoBehaviour
{
    ...
    {
        scrollPosition = GUI.BeginScrollView(new Rect(10, 100, 320, 240), scrollPosition, rctWindow2);
    ...
    {
        scrollPosition2 = GUI.BeginScrollView(new Rect(10, 10, 250,300), scrollPosition2, new Rect(0, 0, 300, 300));
